...
public class CardGridView extends GridView implements CardViewWrapper.OnExpandListAnimatorListener {
    ...
    /**
     * Set {@link chickennugget.spaceengineersdata.cards.CardGridCursorAdapter} and layout used by items in ListView
     *
     * @param adapter {@link chickennugget.spaceengineersdata.cards.CardGridCursorAdapter}
     */
